// Accepts filename (String) as command-line argument; and visually reports if the percolation
// system whose size and open sites are specified by the file percolates or not.
