...
*
        ...
        *
*
*       NULL -> A(enguue) ->A.right -> c.left -> C(enqueue)
*   ->A
*   E
*
*  A C E H M R S X
...
//            StdOut.println(s + " " + st.get(s));
        ...
        for (String s:st.prekeys()   ) {
            StdOut.print( " " + st.get(s)+"\t");

        }
        System.out.println();
        for (String s:st.postkeys()) {
            StdOut.print( " " + st.get(s)+"\t");
